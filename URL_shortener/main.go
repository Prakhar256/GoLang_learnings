...
func redirectURLHandler(w http.ResponseWriter, r *http.Request) {
	...
	// This retrieves the full path of the request URL. For example, if the full URL is http://localhost:3000/redirect/abc123, then r.URL.Path would give you the string "/redirect/abc123".
...
func main() {
	...
	// OriginalURL := "https://github.com/Prakhar256/"
